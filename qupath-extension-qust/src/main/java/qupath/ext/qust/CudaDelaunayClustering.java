 ...
 *
 */
public class CudaDelaunayClustering<T> extends AbstractInteractivePlugin<T> {

	private static final Logger logger = LoggerFactory.getLogger(CudaDelaunayClustering.class);
	
	/**
	 * Constructor.
	 */
	public CudaDelaunayClustering() {
		super();
	}	
	...
	private static class DelaunayRunnable implements PathTask {
		...
		public void run() {
			...
			CudaDelaunayTriangulation dt = new CudaDelaunayTriangulation(pathObjects, pixelWidth, pixelHeight, distanceThresholdPixels, limitByClass);
